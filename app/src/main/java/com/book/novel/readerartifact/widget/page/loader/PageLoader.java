package com.book.novel.readerartifact.widget.page.loader;
...
import com.book.novel.readerartifact.widget.page.TxtPage;
...
public abstract class PageLoader {
    ...
    // 书本对象
    protected CollectBookBean mCollBook;
    // 监听器
    ...
    /*****************************init params*******************************/
    public PageLoader(PageView pageView, CollectBookBean collBook) {
        mPageView = pageView;
...
//                .getBookRecord(mCollBook.get_id());
    ...
    private void drawBackground(Bitmap bitmap, boolean isUpdate) {
        ...
        //底部的字显示的位置Y
        float y = mDisplayHeight - mTipPaint.getFontMetrics().bottom - tipMarginHeight;
        String time = StringUtils.dateConvert(System.currentTimeMillis(), CommonString.FORMAT_TIME);
