...
import static com.book.novel.readerartifact.widget.page.ReadSettingManager.SHARED_READ_CONVERT_TYPE;
...
public class StringUtils {
    ...
    public static String getString(@StringRes int id){
        return HiApplication.getContext().getResources().getString(id);
    }

    public static String getString(@StringRes int id, Object... formatArgs){
        return HiApplication.getContext().getResources().getString(id,formatArgs);
    }
