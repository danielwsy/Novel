...
/** 
 * DAO for table "COLLECT_BOOK_BEAN".
*/
public class CollectBookBeanDao extends AbstractDao<CollectBookBean, String> {
    ...
    /**
     * Properties of entity CollectBookBean.<br/>
    ...
    public CollectBookBeanDao(DaoConfig config) {
        super(config);
    }
    
    public CollectBookBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COLLECT_BOOK_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COLLECT_BOOK_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CollectBookBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CollectBookBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void attachEntity(CollectBookBean entity) {
    ...
    @Override
    public CollectBookBean readEntity(Cursor cursor, int offset) {
        CollectBookBean entity = new CollectBookBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, CollectBookBean entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(CollectBookBean entity, long rowId) {
        return entity.get_id();
    }
    
    @Override
    public String getKey(CollectBookBean entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CollectBookBean entity) {
