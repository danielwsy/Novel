...
public class BookChapterBeanDao extends AbstractDao<BookChapterBean, String> {
    ...
    private Query<BookChapterBean> collectBookBean_BookChapterListQuery;
    ...
    /** Internal query to resolve the "bookChapterList" to-many relationship of CollectBookBean. */
    public List<BookChapterBean> _queryCollectBookBean_BookChapterList(String bookId) {
        synchronized (this) {
            if (collectBookBean_BookChapterListQuery == null) {
                QueryBuilder<BookChapterBean> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.BookId.eq(null));
                collectBookBean_BookChapterListQuery = queryBuilder.build();
            }
        }
        Query<BookChapterBean> query = collectBookBean_BookChapterListQuery.forCurrentThread();
